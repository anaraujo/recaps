...
export default function Artist({
  ...
  return (
    <button className="group from-brand-orange hover:to-brand-orange relative mx-auto aspect-square w-full max-w-81.25 rounded-[100%] bg-linear-to-t from-25% to-transparent to-25%">
      <img
        src={image}
        alt={name}
        width={325}
