...
export default function NewsItem({
  ...
  return (
    <div className="group relative mx-auto aspect-square w-full max-w-[325px]">
      ...
      <svg
        viewBox="0 0 100 100"
        className="pointer-events-none absolute inset-0 z-10 h-full w-full origin-[88%_12%] -rotate-[18deg] transition-transform duration-300 ease-out group-hover:rotate-[22deg]"
      >
        {/* pivot base */}
